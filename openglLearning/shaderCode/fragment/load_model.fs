...
void main() {
    ...
    vec3 refractTextureColor = texture(material.texture_ambient1, TexCoords).rgb;
    vec3 refractColor = texture(skybox, R).rgb * refractTextureColor;
    ...
    FragColor = vec4(refractColor + diffuse, 1.0);
